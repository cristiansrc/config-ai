---
description: Clarifies product requirements before Planner by producing a requirements brief with scope, actors, flows, risks, constraints, and open questions.
mode: all
