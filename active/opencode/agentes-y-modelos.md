...
| enterprise-spec-validator| google/gemini-3.1-pro-preview     | allow             | deny  | Valida la coherencia global del Solution Workspace, contratos de integración y deuda técnica global siguiendo `workspace-coordination`.          |
...
| planner               | google/gemini-3.1-pro-preview | allow             | deny  | Planifica incrementos SDD y diseña contratos. Consulta a `solution-architect` para decisiones de patrones complejos.                              |
...
| spec-validator        | google/gemini-3.1-pro-preview    | allow limitado    | deny  | Valida la consistencia de los artefactos SDD siguiendo `spec-driven-development`.                                                                 |
