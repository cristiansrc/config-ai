...
- `architect-executor`: para tareas técnicas complejas y refactorizaciones locales cuando NO existe especificación SDD formal o completa, utilizando el modelo de alta precisión `opencode-go/deepseek-v4-pro` (plan go).
