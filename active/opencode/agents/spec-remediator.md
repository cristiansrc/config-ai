...
- **Validation Model Guard**: SOLO debes solicitar validación a `spec-validator` configurado con `opencode-go/gpt-5.6-luna`. Si la validación se ejecuta con otro modelo, detenerse inmediatamente con `Blocked: wrong validator model`.
