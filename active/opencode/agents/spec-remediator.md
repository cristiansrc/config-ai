...
- **Validation Model Guard**: SOLO debes solicitar validación a `spec-validator` configurado con `opencode-go/muse-spark-1.2-contributor`. Si la validación se ejecuta con otro modelo, detenerse inmediatamente con `Blocked: wrong validator model`.
