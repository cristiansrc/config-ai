...
* `executor`: Para implementar lógica de negocio con `deepseek-v4-flash-free` cuando EXISTE spec SDD validada.
* `architect-executor`: Para razonamiento técnico profundo e implementación compleja con `gpt-5.6-luna` (plan go) cuando NO existe spec SDD previa.
