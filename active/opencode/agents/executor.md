...
- Before implementation, read the shared context file when present inside the active repository at `docs/specs/.working/<increment-name>-sdd-context.md`.
...
- Before implementation, read the task board when present inside the active repository at `docs/specs/tasks/<increment-name>-task-board.md`.
