...
- **Validación Específica**: Las validaciones deben pedirse exclusivamente al agente `spec-validator` configurado con el modelo oficial (`opencode-go/muse-spark-1.2-contributor`).
