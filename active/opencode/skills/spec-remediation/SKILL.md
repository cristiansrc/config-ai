...
- **Validación Específica**: Las validaciones deben pedirse exclusivamente al agente `spec-validator` configurado con el modelo oficial (`opencode-go/qwen3.7-plus`).
