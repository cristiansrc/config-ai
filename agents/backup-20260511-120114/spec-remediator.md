...
2. Call or request Spec Validator first for a full validation of all active specs and canonical artifacts.
...
7. Ask Spec Validator to validate only that finding against the changed artifacts.
...
12. After all known safe findings are resolved, ask Spec Validator for a full validation of all active artifacts.
